...
public class MyDNA extends DNA
{
	...
	public MyDNA mutate ()
	{
		...
		int index = ran.nextInt(this.getLength());
		char character = (char)(ran.nextInt(26) + 'A');

		String dna = this.getChromosome();
		char[] dnaArray = dna.toCharArray();
		dnaArray[index] = character;

		copy.setChromosome(String.valueOf(dnaArray));
